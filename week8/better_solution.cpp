...
class Employee
{
  ...
  public:
    ...
    void set_is_hourly(bool in_h);
    void printEntry();


};

void Employee::set_compensation ( double in_comp){
   compensation = in_comp;
}
void Employee::set_first_name(char* in_name){ strcpy(first_name, in_name);}
void Employee::set_last_name( char* in_name){ strcpy(last_name, in_name);}
void Employee::set_is_hourly(bool in_h){ hourly_employee = in_h;}
void Employee::printEntry(){
  cout << first_name << " ";
  cout << last_name << " ";
  if (hourly_employee){
